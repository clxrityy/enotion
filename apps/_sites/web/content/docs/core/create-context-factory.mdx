...
- [Advanced: Additional Context](#advanced-additional-context)
...
<Table
  rows={[
    {
      title: "initialContextState",
      items: ["T", "The initial state/value of the context"]
    },
    {
      title: "useContextState",
      items: ["() => T", "A hook that returns the current state of the context"]
    }
  ]}
  striped
  bordered
