...
- [Props](#props)
- [Examples](#examples)
  - [Single Search Key](#single-search-key)
  - [Multiple Search Keys](#multiple-search-keys)
  - [Hide Results When Empty](#hide-results-when-empty)
  - [Complex Rendering](#complex-rendering)
  - [With Custom Styling](#with-custom-styling)
  - [Nested Object Search](#nested-object-search)
- [Features](#features)
- [Styling](#styling)
