...
describe('LayoutContainer', () => {
  it('renders children correctly when passed directly', () => {
    const { getByText } = render(
      <LayoutContainer colorPalette="default" renderChildren={<div>Test Child</div>} />
    );
  ...
  it('renders children correctly when passed via function', () => {
    const { getByText } = render(
      <LayoutContainer
        ...
        renderChildren={() => [<div key="1">Child 1</div>, <div key="2">Child 2</div>]}
      />
    );
  ...
  it('applies color palette styles correctly', () => {
    const { container } = render(
      <LayoutContainer colorPalette="default" renderChildren={<div>Styled Child</div>} />
    );
