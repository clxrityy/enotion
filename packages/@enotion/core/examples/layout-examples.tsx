...
export const useAnimatedModalSystem = () => {
    const { registerElement, showElement, hideElement, createGroup } = useLayoutContext();
    ...
    const showModal = (id: string, content: React.ReactNode, animation?: AnimationConfig) => {
        registerElement({
            id,
            content: (
...
export const useToastSystem = () => {
    ...
    const showToast = (
        ...
        registerElement({
            id,
            content: (
                <div className={`${colors[type]} text-white p-4 rounded-lg shadow-lg flex items-center justify-between min-w-80`}>
                    <span>{message}</span>
                    <button
                        onClick={() => hideElement(id)}
...
export const useSidebarSystem = () => {
    const { createGroup, showGroup, hideGroup, toggleElement } = useLayoutContext(); React.useEffect(() => {
...
const LeftSidebar = () => (
    <div className="fixed left-0 top-0 h-full w-64 bg-gray-800 text-white p-6">
        ...
        <nav className="space-y-2">
            ...
            <a href="/projects" className="block py-2 px-3 rounded hover:bg-gray-700">Projects</a>
    ...
    <div className="fixed right-0 top-0 h-full w-80 bg-white border-l p-6">
        ...
        <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded">
                ...
                <p className="text-sm text-gray-600 mt-1">Manage your tasks and projects</p>
            </div>
            <div className="p-4 bg-gray-50 rounded">
...
export const EnhancedLayoutDemo = () => {
    ...
    const { toggleLeftSidebar, toggleRightSidebar, hideAllSidebars } = useSidebarSystem();
            ...
            <div className="min-h-screen bg-gray-50">
                <header className="bg-white shadow p-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2 flex-wrap">
                            ...
                            <button
                                onClick={() => showModal('info-modal', <div><h3>Information</h3><p>This is an animated modal!</p></div>)}
                                className="px-3 py-1 bg-purple-500 text-white rounded text-sm"
                            >
                                Show Modal
                            </button>
                            <button
                                onClick={() => showConfirmModal('Are you sure you want to delete this item?', () => showSuccess('Item deleted!'))}
                ...
                <main className="p-6">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow">
                        <h2 className="text-lg font-semibold mb-4">Enhanced Layout Features</h2>
                        <ul className="space-y-2 text-gray-600">
                            <li>✨ <strong>Animations:</strong> Smooth enter/exit animations with custom CSS classes</li>
                            <li>🎯 <strong>Groups:</strong> Exclusive and non-exclusive element grouping</li>
                            <li>📱 <strong>Conditional Rendering:</strong> Responsive elements based on conditions</li>
                            <li>⚡ <strong>Priority System:</strong> Conflict resolution for overlapping elements</li>
                            <li>🔄 <strong>Dynamic Registration:</strong> Register/unregister elements on demand</li>
                            <li>🎨 <strong>Z-Index Management:</strong> Automatic layering and positioning</li>
                        </ul>
                    </div>
                </main>
            </div>
